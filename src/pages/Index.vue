<template>
  <div class="q-my-lg q-gutter-y-md">
    ...
    <div>
      ...
      to how to build a world that is more just. It generates article outlines
      that spark the creativity in change-making educators. The tool gives
      social researchers access to knowledge based on millions of webpages and
      books, being unprecedented in its size.
    </div>
    <h2>Safe & responsible AI</h2>
    <div>
      We believe artificial intelligence can help the public good, if used
      responsibly. These are the steps we take to ensure safe use of this tool:
      <ul>
        <li>
        ...
        <li>
          All AI generated text is scanned using a content filter, to warn users
          about potentially sensitive or unsafe content.
        </li>
        <li>
          User input is limited to work within predefined article themes. Users
          are nudged toward acceptable queries, by providing input examples.
        </li>
        <li>
          Users are informed about the risks of using AI to generate text. They
          are regularly reminded not to copy & paste the output, and to conduct
          manual factchecks.
        </li>
        <li>
          ...
          intelligence. In addition, they must always refer back to Rebel Write,
          so readers can get more information about the workings of this tool.
        </li>
        <li>
        ...
        <li>
          To avoid abuse, we limit the number of articles produced per month and
          protect our backend resources using Firebase App Check.
        </li>
      </ul>
    </div>
    <div></div>
